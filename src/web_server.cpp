...
.setupLayout{grid-template-columns:1.15fr .85fr}.utilityPanel .actions{grid-template-columns:repeat(2,1fr);gap:7px}.utilityPanel .actions button{min-height:32px;padding:6px 5px;font-size:11px;white-space:nowrap}.endpointGroup,.manualMovement{grid-column:1/-1}.endpointGroup .actions{width:100%;max-width:100%;margin:0 auto;grid-template-columns:repeat(3,minmax(0,1fr));justify-items:stretch}.endpointGroup .actions button{width:auto;text-align:center}.panel h2,.settingsGroup h3,.endpointGroup h3{text-align:center;font-weight:800}.endpointGroup{margin-top:14px;border-top:1px solid var(--line);padding-top:14px}
</style>
<section class="status"><div class="metric"><div id="state" class="value">Idle</div><span class="caption">State</span></div><div class="metric"><div id="remaining" class="value">0</div><span class="caption">Shots Left</span></div><div class="metric"><div id="distance" class="value">0</div><span class="caption">Distance (mm)</span></div><div class="metric"><div id="stepLength" class="value">0</div><span class="caption">Step Length (&micro;m)</span></div><div class="metric"><div id="shots" class="value">0</div><span class="caption">Total Shots</span></div></section>
<div class="layout setupLayout"><section class="panel"><h2>Setup</h2><div class="settings">
<div class="settingsGroup"><h3>Capture Setup</h3><label class="field">Mode <select id="modeInput" title="Stacking Distance Calculates Shots From Total Travel. Start / Stop Uses The Manually Recorded Endpoints."><option value="distance">Stacking Distance</option><option value="steps">Start / Stop</option></select></label><label class="field" title="Set The Length Of Travel For The Stack To Shoot.">Stacking Distance (mm) <input id="distanceInput" type="number" min="0" max="5000"></label><label class="field" title="Choose The Optical Formula That Matches Your Lens Setup.">Optical Mode <select id="methodInput" title="Macro Lens Uses A Standard Macro Lens. Microscope Objective Uses A Microscope Objective. Stacked Lenses Uses Two Stacked Lenses, Front Lens Reversed And Aperture Controlled."><option value="macro">Macro Lens</option><option value="objective">Microscope Objective</option><option value="reverse">Stacked Lenses</option></select></label><label class="field" title="Camera Settling Time After A Move.">Setting Delay (s) <input id="delayInput" type="number" min="0" max="3600"></label><label class="field" title="Steps/&#956;m = Stepper Motor Steps Per Rotation x Microsteps / Leadscrew Travel In &#956;m.">Steps / &#956;m <input id="stepsInput" type="number" min="0.01" step="0.01"></label><label class="field">Sensor Type <select id="sensorInput"><option value="0">Full Frame</option><option value="1">APS-C</option><option value="2">Micro Four Thirds</option></select></label></div>
<div class="settingsGroup"><h3>Optical Values</h3><label class="field" title="Not Used In Microscope Objective Mode.">Nominal Aperture <input id="apertureInput" type="number" min="0.1" step="0.1"></label><label class="field" title="Standard Macro Lens Magnification When Using A Macro Lens; Otherwise The Calculated Magnification.">Magnification <input id="magInput" type="number" min="0.1" step="0.1"></label><label class="field" title="Calculated Depth Of Field For The Current Optical Settings.">Depth Of Field (&#956;m) <input id="depthOfFieldInput" type="number" readonly></label><label class="field" title="For A Microscope Objective: Magnification Divided By Two Times Numerical Aperture.">Effective Aperture <input id="effectiveApertureInput" type="number" readonly></label></div>
